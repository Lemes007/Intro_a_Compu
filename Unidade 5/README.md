...
Agora, cada grupo deverá escolher uma cartilha oficial disponível no CERT.br e, a partir dela, desenvolver um artefato criativo que explique uma ameaça e como se proteger dela.

**Cartilha utilizada:** `PDF_Backup`
...
Cada integrante deve produzir um texto curto (1 página) respondendo à seguinte pergunta:
